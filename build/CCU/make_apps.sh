...
APP_ARRAY=(smiOS wirelessDCM dbCenter desktopGui acMeter rspSample btManager uartManager pdsManager scsMonitor taskManager puAmr)
APP_DIR=($CODE_DIR/app_sys_smiOS/code $CODE_DIR/app_base_wirelessDCM/code $CODE_DIR/app_base_dbCenter/code $CODE_DIR/app_base_desktopGui/code \
         $CODE_DIR/app_base_acMeter/code $CODE_DIR/app_base_rspSample/code $CODE_DIR/app_base_btManager/code  $CODE_DIR/app_base_uartManager/code \
		 $CODE_DIR/app_edg_pdsManager/code $CODE_DIR/app_sys_secManager/code $CODE_DIR/app_edg_taskManager/code $CODE_DIR/app_adv_puAmr/code) 

# 福建地区ccoRouter特殊
if [ "fujian" == "$AREA_NAME" ]; then
	APP_ARRAY+=(ccoRouter)
	APP_DIR+=($CODE_DIR/app_base_ccoRouter_FJ/code)
else
	APP_ARRAY+=(ccoRouter)
	APP_DIR+=($CODE_DIR/app_base_ccoRouter/code)
fi
