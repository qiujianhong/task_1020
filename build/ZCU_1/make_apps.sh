...
APP_ARRAY=(smiOS dbCenter desktopGui acMeter rspSample usbManager scsMonitor uartManager wirelessDCM taskManager stAmr radioManager)
APP_DIR=($CODE_DIR/app_sys_smiOS/code $CODE_DIR/app_base_dbCenter/code $CODE_DIR/app_base_desktopGui/code $CODE_DIR/app_base_acMeter/code $CODE_DIR/app_base_rspSample/code \
		 $CODE_DIR/app_base_usbManager/code $CODE_DIR/app_sys_secManager/code $CODE_DIR/app_base_uartManager/code $CODE_DIR/app_base_wirelessDCM/code \
		 $CODE_DIR/app_edg_taskManager/code $CODE_DIR/app_adv_stAmr/code $CODE_DIR/app_base_radioManager/code) 
