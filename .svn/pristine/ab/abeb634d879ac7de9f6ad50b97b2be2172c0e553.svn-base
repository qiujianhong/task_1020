...
const OAD_TAB_T oadVariateInfoList[] = 
{
    ...
    {{0x20000200}, 3,       0x02,   0x00, 0,      DT_ARRAY,                sizeof(OOP_WORD3V_T),    E_OOP_WORD3V_T},                 //电压  OOP_DWORD3V_T分相变量都用这个结构体？？？
    ...
    {{0x20000400}, 3,       0x02,   0x00, 0,      DT_ARRAY,                sizeof(OOP_DWORD3V_T),   E_OOP_DWORD3V_T},                 //高精度电压  
    {{0x20000401}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //高精度A相电压
    {{0x20000402}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //高精度B相电压
    {{0x20000403}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //高精度C相电压
    {{0x20000600}, 3,       0x02,   0x00, 0,      DT_LONG_UNSIGNED,        sizeof(uint16),          E_LONG_UNSIGNED},                 //零序
    {{0x20000a00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //AB线电压
    {{0x20000b00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //AB线电压
    {{0x20000c00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //AB线电压
    ...
    {{0x20010400}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //零线电流
    {{0x20010600}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //零序电流
    {{0x20010a00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //负载A相电流
    {{0x20010b00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //负载B相电流
    {{0x20010c00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //负载C相电流
    {{0x20010d00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //输出A相电流
    {{0x20010e00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //输出B相电流
    {{0x20010f00}, 3,       0x02,   0x00, 0,      DT_DOUBLE_LONG,          sizeof(int32),           E_DOUBLE_LONG},                   //输出C相电流
    ...
    {{0x200A0201}, 4,       0x02,   0x00, 0,      DT_LONG,                 sizeof(int16),           E_LONG},                          //功率因数 总
    {{0x200A0202}, 4,       0x02,   0x00, 0,      DT_LONG,                 sizeof(int16),           E_LONG},                          //功率因数 A
    {{0x200A0203}, 4,       0x02,   0x00, 0,      DT_LONG,                 sizeof(int16),           E_LONG},                          //功率因数 B
    {{0x200A0204}, 4,       0x02,   0x00, 0,      DT_LONG,                 sizeof(int16),           E_LONG},                          //功率因数 C
    {{0x200B0200}, 3,       0x02,   0x00, 0,      DT_LONG,                 sizeof(int16),           E_LONG},                          //电压波形失真度
    ...
    {{0x200C0200}, 3,       0x02,   0x00, 0,      DT_LONG,                 sizeof(int16),           E_LONG},                          //电流波形失真度
	...
	{{0x20330200}, 5,       0x02,   0x00, 0,      DT_ARRAY,                sizeof(OOP_HARMONIC_VOL_T),  E_OOP_HARMONIC_U_VALUE_T},                //A相电压谐波含有量（2…n次）
    {{0x20330300}, 5,       0x02,   0x00, 0,      DT_ARRAY,                sizeof(OOP_HARMONIC_VOL_T),  E_OOP_HARMONIC_U_VALUE_T},                //B相电压谐波含有量（2…n次）
    {{0x20330400}, 5,       0x02,   0x00, 0,      DT_ARRAY,                sizeof(OOP_HARMONIC_VOL_T),  E_OOP_HARMONIC_U_VALUE_T},                //C相电压谐波含有量（2…n次）
    ...
    {{0x25000200}, 12,      0x02,   0x05, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //累计水（热）流量
    {{0x25010200}, 12,      0x02,   0x05, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //累计气流量
    {{0x25020200}, 12,      0x02,   0x05, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //累计热量
    {{0x25030200}, 12,      0x02,   0x05, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //热功率
    {{0x25040200}, 12,      0x02,   0x05, 0,      DT_DOUBLE_LONG_UNSIGNED, sizeof(uint32),          E_DOUBLE_LONG_UNSIGNED},          //累计工作时间
    {{0x25050200}, 12,      0x02,   0x05, 0,      DT_STRUCTURE,            sizeof(OOP_WORD2_T),     E_OOP_WORD2_T},                   //水温
    {{0x25060200}, 12,      0x02,   0x05, 0,      DT_STRUCTURE,            sizeof(OOP_ST_T),        E_OOP_ST_T},                      //（仪表）状态ST
};          
...
const OAD_TAB_T oadEvnetInfoList[] =
{
	...
	{{0x30000A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表失压事件 - 当前值记录表
	...
	{{0x30010A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表欠压事件 - 当前值记录表
	...
	{{0x30020A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表过压事件 - 当前值记录表
	...
	{{0x30030A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表断相事件 - 当前值记录表
	...
	{{0x30040A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表失流事件 - 当前值记录表
	...
	{{0x30050A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表过流事件 - 当前值记录表
	{{0x30050B00}, 24,      0x03,   0x00, 0,      DT_ENUM,                 sizeof(uint8),                E_UNSIGNED},                     //电能表过流事件 - 上报标识
	...
	{{0x30060A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表断流事件 - 当前值记录表
	...
	{{0x30070A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表功率反向事件 - 当前值记录表
	...
	{{0x30080A00}, 24,      0x03,   0x00, 1,      DT_ARRAY,                2*sizeof(uint32),             E_DOUBLE_LONG_UNSIGNED},         //电能表过载事件 - 当前值记录表
	...
	{{0x30090600}, 7,       0x03,   0x00, 0,      DT_STRUCTURE,            sizeof(OOP_EVTCFG_WD_T),      E_OOP_EVTCFG_WD_T},              //电能表正向有功需量超限事件 - 配置参数
	...
	{{0x300A0600}, 7,       0x03,   0x00, 0,      DT_STRUCTURE,            sizeof(OOP_EVTCFG_WD_T),      E_OOP_EVTCFG_WD_T},              //电能表反向有功需量超限事件 - 配置参数
...
const OAD_TAB_T oadParaInfoList[] =
{
    ...
    {{0x40120200}, 8,      0x04,   0x00, 0,      DT_BIT_STRING,            sizeof(OOP_VISIBLESTR8_T),        E_OOP_VISIBLESTR8_T},        //周休日特征字
    ...
    {{0x40160201}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 1
    {{0x40160202}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 2
    {{0x40160203}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 3
    {{0x40160204}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 4
    {{0x40160205}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 5
    {{0x40160206}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 6
    {{0x40160207}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 7
    {{0x40160208}, 8,      0x04,   0x00, 0,      DT_STRUCTURE,             sizeof(DAYPERIOD),                E_OOP_DAYPERIOD_T},          //当前套日时段表 8
    ...
    {{0x43000B00}, 19,     0x04,   0x03, 0,      DT_VISIBLE_STRING,        sizeof(OOP_VISIBLEVAR32_T),       E_OOP_VISIBLEVAR32_T},       //电气设备-按键密码
    ...
    {{0x44010200}, 25,     0x04,   0x04, 0,      DT_STRUCTURE,             sizeof(OOP_VISIBLEVAR32_T),       E_OOP_VISIBLEVAR32_T},       //认证密码
    ...
    {{0x45000700}, 25,     0x04,   0x05, 0,      DT_VISIBLE_STRING,        sizeof(OOP_VISIBLESTR20_T),       E_OOP_VISIBLESTR20_T},       //公网通信模块参数1 - SIM卡的ICCID
    {{0x45000800}, 25,     0x04,   0x05, 0,      DT_VISIBLE_STRING,        sizeof(OOP_VISIBLESTR15_T),       E_OOP_VISIBLESTR15_T},       //公网通信模块参数1 - IMSI
    {{0x45000900}, 25,     0x04,   0x05, 0,      DT_LONG,                  sizeof(int16),                    E_LONG_UNSIGNED},            //公网通信模块参数1 - 信号强度
    ...
    {{0x45200200}, 8,      0x04,   0x05, 0,      DT_ARRAY,                 sizeof(OOP_APNGROUP_T),           E_OOP_APNGROUP_T},           //公网远程通信多接入点备用通道
};
...
const OAD_TAB_T oadCollectInfoList[] = 
{
    ...
    {{0x601E0200}, 11,     0x06,   0x00, 1,      DT_ARRAY,                 sizeof(OOP_ACQ_MONITOR_T),       E_OOP_ACQ_MONITOR_T},        //采集规则库
    ...
    {{0x60400200}, 8,       0x02,   0x00, 0,      DT_DATETIME_S,           sizeof(OOP_DATETIME_S_T),        E_DATETIME_S},                    //事件发生时间
    {{0x60410200}, 8,       0x02,   0x00, 0,      DT_DATETIME_S,           sizeof(OOP_DATETIME_S_T),        E_DATETIME_S},                    //事件结束时间
    {{0x60420200}, 8,       0x02,   0x00, 0,      DT_DATETIME_S,           sizeof(OOP_DATETIME_S_T),        E_DATETIME_S},
};
...
const OAD_TAB_T oadControlInfoList[] = 
{
    ...
    {{0x80030200}, 8,      0x08,   0x00, 0,      DT_STRUCTURE,             sizeof(CHINESEINFO),             E_CHINESEINFO},              //一般中文信息
    {{0x80040200}, 8,      0x08,   0x00, 0,      DT_STRUCTURE,             sizeof(CHINESEINFO),             E_CHINESEINFO},              //重要中文信息
...
const OAD_TAB_T oadIoInfoList[] = 
{
	...
	{{0xF2090600}, 22,     0x0F,   0x02, 0,      DT_ARRAY,                 sizeof(OOP_TI_T),                 E_OOP_TI_T},                 //载波/微功率无线接口，从节点对象列表更新周期
	...
	//{{0xF20B0200}, 22,     0x0F,   0x02, 0,      DT_ARRAY,                 0xffffffff},                     E_fffff},                   //蓝牙模块,目前没有对应结构体
    ...
    //{{0xF2100300}, 8,      0x0F,   0x02, 0,      DT_STRUCTURE,             sizeof(uint8)},                  E_UNSIGNED},                //从节点单元，目前没有对应结构体
};
...
const OMD_INFO_T omdParaInfoList[] =
{
    ...
    {{0x43000400}, 19,     0x04,   0x03, 0,      DT_NULL,                  0,                                E_NULL}, 
    {{0x43000500}, 19,     0x04,   0x03, 0,      DT_NULL,                  0,                                E_NULL},                    //恢复出厂参数
};
...
const OMD_INFO_T omdCollectInfoList[] = 
{
    ...
    {{0x601A0200}, 11,     0x06,   0x00, 1,      DT_ARRAY,                 sizeof(OOP_TRANSRES_T),          E_OOP_TRANSRES_T},           //透明方案结果集
    {{0x601C0200}, 11,     0x06,   0x00, 1,      DT_ARRAY,                 sizeof(OOP_PLAN_REPORT_T),       E_OOP_PLAN_REPORT_T},        //上报方案集
    {{0x601C7F00}, 11,     0x06,   0x00, 1,      DT_ARRAY,                 0,        						E_OOP_PLAN_REPORT_T},        //上报方案集
    {{0x601C8100}, 11,     0x06,   0x00, 1,      DT_NULL,                  0,        						E_NULL},                     //上报方案集
    {{0x601E0200}, 11,     0x06,   0x00, 1,      DT_NULL,                  0,                               E_NULL},                     //采集规则库
    {{0x601E7F00}, 11,     0x06,   0x00, 1,      DT_NULL,                  0,                               E_NULL},                     //采集规则库
    {{0x60320200}, 11,     0x06,   0x00, 1,      DT_ARRAY,                 sizeof(OOP_ACQ_RLUESTATE_T),     E_OOP_ACQ_RLUESTATE_T},      //采集状态集
    {{0x60340200}, 11,     0x06,   0x00, 1,      DT_ARRAY,                 sizeof(OOP_ACQ_MONITOR_T),       E_OOP_ACQ_MONITOR_T},        //采集任务监控集
};
...
const OMD_INFO_T omdEsamInfoList[] = 
{
    ...
    {{0xF1017F00}, 8,     0x0F,   0x01, 0,      DT_STRUCTURE,             sizeof(SECURITYMODE),              E_SECURITYMODE},              //增加显式安全模式参数（参数）
...
const OMD_INFO_T omdIoInfoList[] = 
{
    ...
    //{{0xF20B7F00}, 22,     0x0F,   0x02, 0,      DT_STRUCTURE,             sizeof(OOPM_PORTPARAM_T),         E_OOPM_PORTPARAM_T},                 //蓝牙配置端口参数（参数）
};
