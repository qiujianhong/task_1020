...
{
    RADIO_PRO_TO_OUT  = 1,              /* 透传 */
    RADIO_PRO_SET_BT  = 2,              /* 配置电台模块参数 */
    RADIO_PRO_GET_BT  = 3,              /* 读取电台模块参数 */
    RADIO_PRO_REPORT  = 4,              /* 电台主动上报参数 */
}RADIO_PROTOCOL_E;
...
{
    RADIO_MODEL_RESTART  = 1,              /* 模块复位 */
    RADIO_MODEL_RESTORE  = 2,              /* 模块恢复出厂设置 */
    RADIO_MODEL_SLEEP    = 3,              /* 模块进入睡眠状态 */
    RADIO_MODEL_WAKE     = 4,              /* 模块退出睡眠状态 */
}RADIO_MODEL_INFO_E;
