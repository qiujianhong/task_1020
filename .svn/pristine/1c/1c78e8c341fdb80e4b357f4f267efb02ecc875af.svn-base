...
static int uart_id_to_num(const char *id)
{
    ...
    if(strcmp(id, UART_232_DEVICE_ID_STR) == 0)
    {
        return TTYS0;
    }
    ...
    else if(strcmp(id, UART_IR_DEVICE_ID_STR) == 0)
    {
        return TTYS5;
    }
    else if(strcmp(id, UART_LOCAL_CU_DEVICE_ID_STR) == 0)
    {
        return TTYS6;
    }
...
static int uart_id_to_devpath(const char *id, char *dev, int devlen)
{
    ...
    {
        memcpy(dev, UART_DEV_NAME_TTYS5, strlen(UART_DEV_NAME_TTYS5));
        return strlen(UART_DEV_NAME_TTYS5);
    }
    else if(strcmp(id, UART_LOCAL_CU_DEVICE_ID_STR) == 0)
    {
