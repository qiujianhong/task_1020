...
fontspath=/usr/share
datapath=/data/app
APPLIST=(smiOS dbCenter desktopGui acMeter rspSample usbManager scsMonitor uartManager wirelessDCM taskManager stAmr sysUpdate)
