...
#define BATTERY_LOW				360		//电池电压3.6V*10%
#define BATTERY_FULL			2880	//电池电压3.6V*80%
...
int check_power_status()
{
	...
	if(vol < BATTERY_LOW)		//电池欠压
	{
        g_template_info.bBatFlag = 0;
	}
	else if(vol >=BATTERY_LOW && vol < BATTERY_FULL)		//电池充电
	{
...
void Template1Draw(HDC hdc)
{
    ...
    {
		nSignal = g_template_info.nSignal/6;
