...
/*
 * $Id: common.h,v 1.2 2012/09/22 03:41:24 gujun Exp $
 *
...
/**
 * \var typedef signed short int16
...
/**
 * \var typedef signed long long int64
 * \brief A type definition for a 64-bit signed integer.
 *
 * \warning Only available under GNU C.
 */
typedef signed MGUI_HAS_64BIT_TYPE int64;
#else
...
MGUI_COMPILE_TIME_ASSERT(int8, sizeof(int8) == 1);
MGUI_COMPILE_TIME_ASSERT(uint16, sizeof(Uint16) == 2);
//MGUI_COMPILE_TIME_ASSERT(int16, sizeof(int16) == 2);
MGUI_COMPILE_TIME_ASSERT(uint32, sizeof(Uint32) == 4);
MGUI_COMPILE_TIME_ASSERT(int, sizeof(int) == 4);
MGUI_COMPILE_TIME_ASSERT(uint64, sizeof(Uint64) == 8);
MGUI_COMPILE_TIME_ASSERT(int64, sizeof(int64) == 8);
...
typedef RGB* PRGB;
     ...
     */
/**
 * \var typedef int8 gal_int8
 * \brief Data type of 8-bit signed integer.
 *
 * \sa int8
 */
typedef int8       gal_int8;
/**
