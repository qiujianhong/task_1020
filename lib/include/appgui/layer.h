...
extern PLUGIN_INFO g_socketstart;                 //主站连接状态
extern PLUGIN_INFO g_remotestatus;                //遥信连接状态
...
/***************************配网****************************
****************************************************************/
extern PLUGIN_INFO g_layer_ethmaster101_display;          //通信通道查看
extern PLUGIN_INFO g_layer_ethmaster104_display;
extern PLUGIN_INFO g_layer_ethmaster101_set;          //通信通道设置
extern PLUGIN_INFO g_layer_ethmaster104_set;           //104通道设置

extern PLUGIN_INFO g_layer_pass_rate_param_display;     //合格率参数
extern PLUGIN_INFO g_layer_pass_rate_param_set;            
/***************************配网****************************
****************************************************************/
...
extern PLUGIN_INFO g_layer_power_off_on_display;      //停上电事件
extern PLUGIN_INFO g_layer_power_ctr_evt_display;
...
extern PLUGIN_INFO g_layer_measure_high_data_display;      //抄表实时数据查看
extern PLUGIN_INFO g_layer_measure_day_high_frozen_display; //抄表日冻结数据查看
...
extern PLUGIN_INFO g_layer_ip_display1;                   //IP地址查看
...
extern PLUGIN_INFO g_layer_task_fail;      //任务状态查看
...
extern PLUGIN_INFO g_layer_gprs_set_cq;                     //GPRS通信配置设置
extern PLUGIN_INFO g_layer_gprs2_set_cq;                     //GPRS通信配置设置
...
extern PLUGIN_INFO g_layer_plus_data_display;       //脉冲数据

extern PLUGIN_INFO g_turnstart;
extern PLUGIN_INFO g_layer_gruop_data_display1;        // 总加组数据 0x11011000
extern PLUGIN_INFO g_layer_gruop_data_display2;        // 总加组数据 
extern PLUGIN_INFO g_layer_gruop_data_display3;        // 总加组数据
extern PLUGIN_INFO g_layer_gruop_data_display4;        // 总加组数据 
extern PLUGIN_INFO g_layer_gruop_data_display5;        // 总加组数据 
extern PLUGIN_INFO g_layer_gruop_data_display6;        // 总加组数据
extern PLUGIN_INFO g_layer_gruop_data_display7;        // 总加组数据 
extern PLUGIN_INFO g_layer_gruop_data_display8;        // 总加组数据 

extern PLUGIN_INFO g_layer_control_group_display1;        // 控制状态1 0x11012000
extern PLUGIN_INFO g_layer_control_group_display2;        
extern PLUGIN_INFO g_layer_control_group_display3;        
extern PLUGIN_INFO g_layer_control_group_display4;        
extern PLUGIN_INFO g_layer_control_group_display5;        
extern PLUGIN_INFO g_layer_control_group_display6;        
extern PLUGIN_INFO g_layer_control_group_display7;        
extern PLUGIN_INFO g_layer_control_group_display8;    

extern PLUGIN_INFO g_layer_plus_param1;                  //脉冲配置
extern PLUGIN_INFO g_layer_plus_param2;
extern PLUGIN_INFO g_layer_plus_param3;
extern PLUGIN_INFO g_layer_plus_param4;
extern PLUGIN_INFO g_layer_plus_param5;
extern PLUGIN_INFO g_layer_plus_param6;
extern PLUGIN_INFO g_layer_plus_param7;
extern PLUGIN_INFO g_layer_plus_param8;

extern PLUGIN_INFO g_layer_gruop_param1;                //总加组配置
extern PLUGIN_INFO g_layer_gruop_param2;
extern PLUGIN_INFO g_layer_gruop_param3;
extern PLUGIN_INFO g_layer_gruop_param4;
extern PLUGIN_INFO g_layer_gruop_param5;
extern PLUGIN_INFO g_layer_gruop_param6;
extern PLUGIN_INFO g_layer_gruop_param7;
extern PLUGIN_INFO g_layer_gruop_param8;

extern PLUGIN_INFO g_layer_control_seting_display1;        // 控制设置状态1 0x11030050
extern PLUGIN_INFO g_layer_control_seting_display2;        
extern PLUGIN_INFO g_layer_control_seting_display3;        
extern PLUGIN_INFO g_layer_control_seting_display4;        
extern PLUGIN_INFO g_layer_control_seting_display5;        
extern PLUGIN_INFO g_layer_control_seting_display6;        
extern PLUGIN_INFO g_layer_control_seting_display7;        
extern PLUGIN_INFO g_layer_control_seting_display8;    
...
extern PLUGIN_INFO g_layer_chinese_info_display1;    //中文信息
extern PLUGIN_INFO g_layer_chinese_info_display2;

extern PLUGIN_INFO g_layer_reset_time;          //终端时间设置
extern PLUGIN_INFO g_safemode;//安全模式
extern PLUGIN_INFO g_layer_address_set_hunan;                 //通信地址设置

extern PLUGIN_INFO g_module_info_display1;                //模块信息  0x11050011
extern PLUGIN_INFO g_module_info_display2;        
extern PLUGIN_INFO g_module_info_display3;        
extern PLUGIN_INFO g_module_info_display4;        
extern PLUGIN_INFO g_module_info_display5;
/***************************专变 公变****************************
****************************************************************/
...
/****************************************************************
***************************模组管理器****************************/
extern PLUGIN_INFO g_moduleInfo1;         //模组1信息
extern PLUGIN_INFO g_moduleInfo2;         //模组2信息
extern PLUGIN_INFO g_moduleInfo3;         //模组3信息
extern PLUGIN_INFO g_moduleInfo4;         //模组4信息
extern PLUGIN_INFO g_moduleInfo5;         //模组5信息
extern PLUGIN_INFO g_modulePlugEvent;     //模组插拔事件
extern PLUGIN_INFO g_appRestart;          //重启应用
extern PLUGIN_INFO g_moduleRestart;          //重启某个模组
extern PLUGIN_INFO g_moduleReset;           //复位某个模组
extern PLUGIN_INFO g_dataInitilize;            //数据初始化
extern PLUGIN_INFO g_paraInitilize;          //参数初始化
extern PLUGIN_INFO g_appVersionInfo;          //应用版本信息
/***************************模组管理器****************************
****************************************************************/
