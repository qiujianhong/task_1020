...
#define SET_CS_LOW              0X6504          	//Set CS/SSN = 0    enaradio CS
#define SET_CS_HIGH             0X6505          	//Set CS/SSN = 1    disaradio CS
...
extern int8 GetTEsam_IKB_Info(uint8_t *id, uint32_t idlen, uint8 *ikb, uint32 *ikradion);
...
extern int8 GetTEsam_SIKB_Info(uint8_t *id, uint32_t idlen, uint8 *sikb, uint32 *sikradion);
