...
extern int puAmr_acMeter_fd_init(void);
extern int puAmr_acMeter_revsnd(uint8 *sndData, uint16 sndLen, uint8 *pOutBuf, uint16 *rcvLen);
extern OOP_DAR_E puAmr_acMeter_set(OOP_OAD_U oad, void *data, uint32 dataLen);
extern OOP_DAR_E puAmr_acMeter_get(OOP_OAD_U oad, void *data, uint32 dataLen);
...
extern int8 ResponseFrameDeal_long(SecurityMode_t secMode,uint8 *pInBuff,uint32 inDataLen,uint8 *pOutBuff,uint32 *pOutDataLen);
...
extern int8 GetTEsam_IKB_Info(uint8_t *id, uint32_t idlen, uint8 *ikb, uint32 *ikblen);
extern int8 GetTEsam_IKC_Info(uint8_t *id, uint32_t idlen, uint8 *ikc, uint32 *ikclen);
extern int8 GetTEsam_IKA_Info(uint8_t *id, uint32_t idlen, uint8 *ika, uint32 *ikalen);
extern int8 GetTEsam_SIKB_Info(uint8_t *id, uint32_t idlen, uint8 *sikb, uint32 *sikblen);
extern int8 GetTEsam_SIKC_Info(uint8_t *id, uint32_t idlen, uint8 *sikc, uint32 *sikclen);
extern int8 GetTEsam_SIKA_Info(uint8_t *id, uint32_t idlen, uint8 *sika, uint32 *sikalen);
