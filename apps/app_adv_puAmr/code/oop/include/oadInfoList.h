...
{	
    ...
    E_OOP_VISIBLESTR256_T,  //变长！！！命名规则要带VAR
    E_OOP_OCTETVAR256_T,            
    E_OOP_OCTETVAR1K_T,    
    E_OOP_OCTETVAR2K_T,  
    ...
    /*集合类*/                                                                  
    E_OOP_CONTAINER_LIST,           //  容器集合
    E_OOP_APP_INFO_LIST,            //应用集合
    /*控制接口类*/
...
#ifdef AREA_SHAANXI
	E_OOP_ICCIDLOG_T,				//ICCID变更事件
	E_4GMONITOR_T,					//4G检测相关信息
#endif

#ifdef AREA_FUJIAN
        E_BATTERY_STATUS_T,             //停电工作电池状态
        E_SINGAL_INFO_T,                //现场信号信息
#endif

    E_Water_Temperature_T,
    E_OOP_FLOW_PARAM_T,
    E_CHECKSUM,                        //24规范校验码数据类型
    E_NULL = 0xFFFFFFFF,
}DATA_E;
