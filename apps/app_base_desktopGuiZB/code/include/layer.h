...
/***************************专变1型****************************
****************************************************************/
extern PLUGIN_INFO g_CommDispDraw1;		// 常显画面  0x20ffff01
extern PLUGIN_INFO g_CommDispDraw2;		// 常显画面  0x20ffff02
extern PLUGIN_INFO g_CommDispDraw3;		// 常显画面  0x20ffff03
extern PLUGIN_INFO g_CommDispDraw4;		// 常显画面  0x20ffff04
extern PLUGIN_INFO g_CommDispDraw5;		// 常显画面  0x20ffff05
extern PLUGIN_INFO g_CommDispDraw6;		// 常显画面  0x20ffff06
extern PLUGIN_INFO g_CommDispDraw7;		// 常显画面  0x20ffff07
extern PLUGIN_INFO g_CommDispDraw8;		// 常显画面  0x20ffff08

extern PLUGIN_INFO g_layer_cur_powerTotal;   			//当前功率
extern PLUGIN_INFO g_layer_gruop_cur_powerTotal;   			//当前功率
extern PLUGIN_INFO g_layer_active_powerTotal;          //有功功率
extern PLUGIN_INFO g_layer_reactive_powerTotal;       //无功功率
extern PLUGIN_INFO g_layer_power_display;            //无功功率
extern PLUGIN_INFO g_layer_ac_high_active_power_display; //当前正向有功电能量示值
extern PLUGIN_INFO g_layer_ac_high_reactive_power_display;//当前正向无功电能量示值
extern PLUGIN_INFO g_layer_high_reverse_power_display;   //当前反向无功电能量示值
extern PLUGIN_INFO g_layer_high_reactive_power_display; //当前反向无功电能量示值
extern PLUGIN_INFO g_layer_cur_EleQ;					//当前电量
extern PLUGIN_INFO g_layer_power_ctr_evt_display;		//功控记录
extern PLUGIN_INFO g_layer_elect_ctr_evt_display;		//电控记录

extern PLUGIN_INFO g_layer_pwct_ctr_evt_display;		//失电记录

extern PLUGIN_INFO g_layer_rct_ctr_evt_display;			//遥控记录
extern PLUGIN_INFO g_layer_switch_state_display;		//开关状态
extern PLUGIN_INFO g_layer_periodCtrl_param_display;	//时段控参数
extern PLUGIN_INFO g_layer_restCtrl_param_display;		//厂休控参数
extern PLUGIN_INFO g_layer_monthCtrl_param_display;		//月电控参数
extern PLUGIN_INFO g_layer_downCtrl_param_display;		//下浮控参数

extern PLUGIN_INFO g_layer_stopCtrl_param_display; 		//报停控参数
extern PLUGIN_INFO g_layer_kivp_display;          		//kikvkp
extern PLUGIN_INFO g_layer_kivp_puls_display;         //脉冲互感
extern PLUGIN_INFO g_layer_meterParam_display;    		//电表参数
extern PLUGIN_INFO g_layer_powerCurve_display;    		//负荷曲线
...
/* 测量点数据                                                           */
/************************************************************************/
extern PLUGIN_INFO g_EquipValDraw1;			// 电表示数  0x20300000
extern PLUGIN_INFO g_EquipValDraw2;			// 电表示数  0x20300001
extern PLUGIN_INFO g_EquipValDraw3;			// 电表示数  0x20300002
extern PLUGIN_INFO g_EquipValDraw4;			// 电表示数  0x20300003
extern PLUGIN_INFO g_EquipValDraw5;			// 电表示数  0x20300004
extern PLUGIN_INFO g_EquipValDraw6;			// 电表示数  0x20300005
extern PLUGIN_INFO g_EquipValDraw7;			// 电表示数  0x20300006
extern PLUGIN_INFO g_EquipValDraw8;			// 电表示数  0x20300007
extern PLUGIN_INFO g_EquipValDraw9;			// 电表示数  0x20300008
extern PLUGIN_INFO g_EquipValDraw10;			// 电表示数  0x20300009
extern PLUGIN_INFO g_EquipValDraw11;			// 电表示数  0x2030000a
extern PLUGIN_INFO g_EquipValDraw12;			// 电表示数  0x2030000b
extern PLUGIN_INFO g_EquipValDraw13;			// 电表示数  0x2030000c
extern PLUGIN_INFO g_EquipValDraw14;			// 电表示数  0x2030000d
extern PLUGIN_INFO g_EquipValDraw15;			// 电表示数  0x2030000e
extern PLUGIN_INFO g_EquipValDraw16;			// 电表示数  0x2030000f

extern PLUGIN_INFO g_HEquipValDraw1;			// 电表示数  0x20300000
extern PLUGIN_INFO g_HEquipValDraw2;			// 电表示数  0x20300001
extern PLUGIN_INFO g_HEquipValDraw3;			// 电表示数  0x20300002
extern PLUGIN_INFO g_HEquipValDraw4;			// 电表示数  0x20300003
extern PLUGIN_INFO g_HEquipValDraw5;			// 电表示数  0x20300004
extern PLUGIN_INFO g_HEquipValDraw6;			// 电表示数  0x20300005
extern PLUGIN_INFO g_HEquipValDraw7;			// 电表示数  0x20300006
extern PLUGIN_INFO g_HEquipValDraw8;			// 电表示数  0x20300007
extern PLUGIN_INFO g_HEquipValDraw9;			// 电表示数  0x20300008
extern PLUGIN_INFO g_HEquipValDraw10;			// 电表示数  0x20300009
extern PLUGIN_INFO g_HEquipValDraw11;			// 电表示数  0x2030000a
extern PLUGIN_INFO g_HEquipValDraw12;			// 电表示数  0x2030000b
extern PLUGIN_INFO g_HEquipValDraw13;			// 电表示数  0x2030000c
extern PLUGIN_INFO g_HEquipValDraw14;			// 电表示数  0x2030000d
extern PLUGIN_INFO g_HEquipValDraw15;			// 电表示数  0x2030000e
extern PLUGIN_INFO g_HEquipValDraw16;			// 电表示数  0x2030000f
/************************************************************************/
/* 测量点数据结束                                                       */
/************************************************************************/
...
/* 中文信息页面库                                                           */
/************************************************************************/
extern PLUGIN_INFO g_ZhMsgInfoDraw1;		// 中文信息1  0x20400000
extern PLUGIN_INFO g_ZhMsgInfoDraw2;		// 中文信息2  0x20400001	
extern PLUGIN_INFO g_ZhMsgInfoDraw3;		// 中文信息3	0x20400002
extern PLUGIN_INFO g_ZhMsgInfoDraw4;		// 中文信息4	0x20400003
extern PLUGIN_INFO g_ZhMsgInfoDraw5;		// 中文信息5	0x20400004
extern PLUGIN_INFO g_ZhMsgInfoDraw6;		// 中文信息6	0x20400005
extern PLUGIN_INFO g_ZhMsgInfoDraw7;		// 中文信息7	0x20400006
extern PLUGIN_INFO g_ZhMsgInfoDraw8;		// 中文信息8	0x20400007
extern PLUGIN_INFO g_ZhMsgInfoDraw9;		// 中文信息9	0x20400008
extern PLUGIN_INFO g_ZhMsgInfoDraw10;		// 中文信息10   0x20400009
...
//extern PLUGIN_INFO g_layerChnlInfo ;  //通讯通道配置
extern PLUGIN_INFO g_layerEthernet ;  //通讯通道配置
extern PLUGIN_INFO g_layer_gprs_set ;  //通讯通道配置
extern PLUGIN_INFO g_layer_networkmode_set ;  //通讯通道配置


extern PLUGIN_INFO g_layerGroupMain;	  // 总加组配置  0x20760000
extern PLUGIN_INFO g_layerPulseMain;	  // 脉冲测量点配置  0x20740000

extern PLUGIN_INFO g_TermDataDraw;		  // 终端信息  0x20600000
...
extern PLUGIN_INFO g_layer_aesam;		// ESAM下发状态


/***************************专变 公变****************************
****************************************************************/
//高精度
extern PLUGIN_INFO g_layer_ac_high_forward_power_display ;  //交采当前正向电能示数
extern PLUGIN_INFO g_layer_ac_high_reverse_power_display ;  //交采当前反向电能示数
extern PLUGIN_INFO g_layer_ac_high_quadrant_power_display ; //交采当前四象限无功电能

extern PLUGIN_INFO g_layer_ac_forward_power_display ;  //交采当前正向电能示数
extern PLUGIN_INFO g_layer_ac_reverse_power_display ;  //交采当前反向电能示数
extern PLUGIN_INFO g_layer_ac_quadrant_power_display ; //交采当前四象限无功电能
extern PLUGIN_INFO g_layer_ac_vol_cur_display ;        //电压电流数据
extern PLUGIN_INFO g_layer_ac_vol_xj_display ;        //电压相角
extern PLUGIN_INFO g_layer_ac_power_display;           //当前功率示数
extern PLUGIN_INFO g_layer_ac_demand_display;          //正反向有功需量
extern PLUGIN_INFO g_layer_ac_remainPower_display1;     //总剩余电量第一屏
extern PLUGIN_INFO g_layer_ac_remainPower_display2;     //总剩余电量第二屏
extern PLUGIN_INFO g_layer_switch_status_display;      //遥信状态
extern PLUGIN_INFO g_layer_pwct_ctr_evt_display;      //停上电事件
...
extern PLUGIN_INFO g_layer_measure_data_display;      //抄表实时数据查看
extern PLUGIN_INFO g_layer_measure_day_frozen_display; //抄表日冻结数据查看
extern PLUGIN_INFO g_layer_harmonic_display;          //谐波含有率
extern PLUGIN_INFO g_layer_harmonic_value_display;    //谐波含量
extern PLUGIN_INFO g_layer_dc_data_display;           //直流模拟量

extern PLUGIN_INFO g_layer_address_display;               //通信地址查看
extern PLUGIN_INFO g_layer_ip_display;                   //IP地址查看
extern PLUGIN_INFO g_layer_eth_display;               //以太网通道查看
extern PLUGIN_INFO g_layer_ethmaster_display;         //以太网主站通信参数查看
extern PLUGIN_INFO g_layer_gprs_display;               //无线公网通道查看
extern PLUGIN_INFO g_layer_gprs2_display;               //无线公网通道查看
extern PLUGIN_INFO g_layer_gprs_numnet;                 //无线公网1多网络配置
extern PLUGIN_INFO g_layer_gprs2_numnet;                 //无线公网2多网络配置
#ifdef AREA_SHAANXI
extern PLUGIN_INFO g_layer_gprs1chanenl_param_set;
extern PLUGIN_INFO g_layer_gprs2chanenl_param_set;
#endif
extern PLUGIN_INFO g_layer_gprsmaster_display;            //GPRS主站配置
extern PLUGIN_INFO g_layer_gprs2master_display;            //GPRS主站配置
extern PLUGIN_INFO g_layer_meterfile_display;             //电表档案查看
extern PLUGIN_INFO g_layer_normal_plan_display;         //普通方案查看
extern PLUGIN_INFO g_layer_event_plan_display;          //事件方案查看
extern PLUGIN_INFO g_layer_report_plan_display;         //上报方案查看
extern PLUGIN_INFO g_layer_task_display;                 //采集任务查看
extern PLUGIN_INFO g_layer_HPLC_display;                //HPLC参数查看

extern PLUGIN_INFO g_Set_ParaResetTime;		//时间设置
extern PLUGIN_INFO g_layerChangePwd;      //密码设置
extern PLUGIN_INFO g_layerac_FeatureCfg;  //交采电流设置
extern PLUGIN_INFO g_layer_restartAPP;      //重启应用
extern PLUGIN_INFO g_layer_reboot_terminal;      //重启终端
extern PLUGIN_INFO g_layer_data_initialization;      //数据初始化
extern PLUGIN_INFO g_layer_param_initialization;      //参数初始化
extern PLUGIN_INFO g_layer_ac_param_initialization;      //交采参数初始化
extern PLUGIN_INFO g_layer_data_param_initialization;    //交采数据初始化
extern PLUGIN_INFO g_layer_task_status;      			 //任务状态查看
extern PLUGIN_INFO g_layer_task_fail;                    //任务失败电表

extern PLUGIN_INFO g_layer_manual_amr;       //手动抄表测试
extern PLUGIN_INFO g_layer_line_net;           //载波组网情况
#ifdef AREA_HUNAN
extern PLUGIN_INFO g_layer_sensor_param;          //传感器参数查看
extern PLUGIN_INFO g_layer_sensor_set;            //传感器参数设置
#endif

extern PLUGIN_INFO g_layer_app_version_display;     //版本信息
extern PLUGIN_INFO g_UpdateStatusDraw;              //升级状态
extern PLUGIN_INFO g_gprsStatusDraw;                //拨号信息
extern PLUGIN_INFO g_ChannelDebugStatusDraw;        //通讯信息
extern PLUGIN_INFO g_layer_tmn_version_display;     //终端版本信息
extern PLUGIN_INFO g_layer_comm_proxy_set;          //通信代理设置
extern PLUGIN_INFO g_layer_address_set;              //通信地址设置
extern PLUGIN_INFO g_layer_address_set1;             //通信地址设置

extern PLUGIN_INFO g_layer_channel_set;                 //通信通道设置
extern PLUGIN_INFO g_layer_ethmaster101_set;
extern PLUGIN_INFO g_layer_ethmaster104_set;
extern PLUGIN_INFO g_layer_meterfile_set;                 //电表档案设置
extern PLUGIN_INFO g_layer_normal_plan_set;           //普通采集方案设置
extern PLUGIN_INFO g_layer_task_set;                  //采集任务设置
extern PLUGIN_INFO g_layer_event_plan_set;           //事件采集方案设置

extern PLUGIN_INFO g_layer_HPLC_set;                 //HPLC参数设置
extern PLUGIN_INFO g_layer_Hchanenl_set;             //载波频点设置
extern PLUGIN_INFO g_layer_ip_set;                      //ip地址设置
extern PLUGIN_INFO g_layer_eth_set;                     //以太网通信配置设置
extern PLUGIN_INFO g_layer_ethmaster_set;                   //以太网主站配置设置
extern PLUGIN_INFO g_layer_gprs_set;                     //GPRS通信配置设置
//extern PLUGIN_INFO g_layer_networkmode_set;                     //GPRS通信配置设置

extern PLUGIN_INFO g_layer_gprsmaster_set;                     //GPRS主站设置
extern PLUGIN_INFO g_layer_gprs2_set;                     //GPRS通信配置设置
extern PLUGIN_INFO g_layer_gprs2master_set;                     //GPRS主站设置
...
extern PLUGIN_INFO g_ZhMsgInfoDraw1;   //中文信息
...
extern PLUGIN_INFO g_disk_status;        //磁盘状态
...
extern PLUGIN_INFO g_BuyDatadisplay1;	// 购电信息1 0x11030040
...
extern PLUGIN_INFO g_layer_HPLC_frequency;                //HPLC频点  
extern PLUGIN_INFO g_layer_meter_reading_port;            //抄表端口  
extern PLUGIN_INFO g_layer_module_address;                //模块地址  
extern PLUGIN_INFO g_layer_module_info;                   //模块信息
extern PLUGIN_INFO g_layer_meter_reading_status;          //抄表状态
extern PLUGIN_INFO g_layer_station_identification;        //台区识别    
extern PLUGIN_INFO g_layer_off_grid_awareness;            //离网感知
extern PLUGIN_INFO g_layer_reject_node_report;            //拒绝节点上报
extern PLUGIN_INFO g_layer_file_info;                     //档案信息
extern PLUGIN_INFO g_layer_restart_app;                   //重启应用
extern PLUGIN_INFO g_layer_hardware_initialization;       //硬件初始化
extern PLUGIN_INFO g_layer_param_initialization;          //参数初始化         
extern PLUGIN_INFO g_layer_app_version_info;              //应用版本信息
#endif

#if MOD_WIRELESSDCM_DCW ==1
extern PLUGIN_INFO g_layerDialingStatusData1;          //无线拨号状态
extern PLUGIN_INFO g_layerDialingStatusData2;
extern PLUGIN_INFO g_layerDialingEventData1;          //无线拨号事件
extern PLUGIN_INFO g_layerDialingEventData2;
extern PLUGIN_INFO g_layerDialingTypeData;             //拨号状态显示
extern PLUGIN_INFO g_layerDialingParamData1;            //拨号参数显示
extern PLUGIN_INFO g_layerDialingParamData2;            
extern PLUGIN_INFO g_layerDialingTypSet;               //拨号状态设置
extern PLUGIN_INFO g_layerDialingPARASet1;             //拨号参数设置
extern PLUGIN_INFO g_layerDialingPARASet2;
extern PLUGIN_INFO g_layerDialingRestartAPP;            //重启应用
extern PLUGIN_INFO g_layerReDialing1;                   //重新拨号
extern PLUGIN_INFO g_layerReDialing2;                   
extern PLUGIN_INFO g_layerDialVersionInfo;              //版本信息
#endif
...
extern PLUGIN_INFO g_layer_ctrl_period_display1;	   // 时段控参数 0x00200108
extern PLUGIN_INFO g_layer_ctrl_period_display2;	   // 时段控参数 0x00200208
extern PLUGIN_INFO g_layer_ctrl_period_display3;	   // 时段控参数 0x00200308
extern PLUGIN_INFO g_layer_ctrl_period_display4;	   // 时段控参数 0x00200408
extern PLUGIN_INFO g_layer_ctrl_period_display5;	   // 时段控参数 0x00200508
extern PLUGIN_INFO g_layer_ctrl_period_display6;	   // 时段控参数 0x00200608
extern PLUGIN_INFO g_layer_ctrl_period_display7;	   // 时段控参数 0x00200708
extern PLUGIN_INFO g_layer_ctrl_period_display8;	   // 时段控参数 0x00200808
...
// 下浮控参数
extern PLUGIN_INFO g_layer_ctrl_down_display1;	// 下浮控参数	0x00210100
extern PLUGIN_INFO g_layer_ctrl_down_display2;	// 下浮控参数	0x00210200
extern PLUGIN_INFO g_layer_ctrl_down_display3;	// 下浮控参数	0x00210300
extern PLUGIN_INFO g_layer_ctrl_down_display4;	// 下浮控参数	0x00210400
extern PLUGIN_INFO g_layer_ctrl_down_display5;	// 下浮控参数	0x00210500
extern PLUGIN_INFO g_layer_ctrl_down_display6;	// 下浮控参数	0x00210600
extern PLUGIN_INFO g_layer_ctrl_down_display7;	// 下浮控参数	0x00210700
extern PLUGIN_INFO g_layer_ctrl_down_display8;	// 下浮控参数	0x00210800
// 厂休控参数
extern PLUGIN_INFO g_layer_ctrl_rest_display1;	// 厂休控参数 0x00220100
extern PLUGIN_INFO g_layer_ctrl_rest_display2;	// 厂休控参数 0x00220200
extern PLUGIN_INFO g_layer_ctrl_rest_display3;	// 厂休控参数 0x00220300
extern PLUGIN_INFO g_layer_ctrl_rest_display4;	// 厂休控参数 0x00220400
extern PLUGIN_INFO g_layer_ctrl_rest_display5;	// 厂休控参数 0x00220500
extern PLUGIN_INFO g_layer_ctrl_rest_display6;	// 厂休控参数 0x00220600
extern PLUGIN_INFO g_layer_ctrl_rest_display7;	// 厂休控参数 0x00220700
extern PLUGIN_INFO g_layer_ctrl_rest_display8;	// 厂休控参数 0x00220800

// 厂休控参数
extern PLUGIN_INFO g_layer_ctrl_month_display1;// 月电控参数 0x00240100
extern PLUGIN_INFO g_layer_ctrl_month_display2;// 月电控参数 0x00240200
extern PLUGIN_INFO g_layer_ctrl_month_display3;// 月电控参数 0x00240300
extern PLUGIN_INFO g_layer_ctrl_month_display4;// 月电控参数 0x00240400
extern PLUGIN_INFO g_layer_ctrl_month_display5;// 月电控参数 0x00240100
extern PLUGIN_INFO g_layer_ctrl_month_display6;// 月电控参数 0x00240200
extern PLUGIN_INFO g_layer_ctrl_month_display7;// 月电控参数 0x00240300
extern PLUGIN_INFO g_layer_ctrl_month_display8;// 月电控参数 0x00240400

extern PLUGIN_INFO g_layer_ctrl_stop_display1;	// 报停控参数 0x00290100
extern PLUGIN_INFO g_layer_ctrl_stop_display2;	// 报停控参数 0x00290200
extern PLUGIN_INFO g_layer_ctrl_stop_display3;	// 报停控参数 0x00290300
extern PLUGIN_INFO g_layer_ctrl_stop_display4;	// 报停控参数 0x00290400
extern PLUGIN_INFO g_layer_ctrl_stop_display5;	// 报停控参数 0x00290100
extern PLUGIN_INFO g_layer_ctrl_stop_display6;	// 报停控参数 0x00290200
extern PLUGIN_INFO g_layer_ctrl_stop_display7;	// 报停控参数 0x00290300
extern PLUGIN_INFO g_layer_ctrl_stop_display8;	// 报停控参数 0x00290400
...
extern PLUGIN_INFO g_layer_kivp_display;  //  3k值
...
/****************************XTL***********************************/
extern PLUGIN_INFO g_layer_config_para;   // 配置参数  
/****************************XTL***********************************/
/************************************************************************/
/* 测量点数据		                                                    */
/************************************************************************/
...
extern PLUGIN_INFO g_layerTermRetset;	// 重启终端设备 0x00B30000
...
extern PLUGIN_INFO g_layerRadioCfg;		// 电台参数设置 0x20B70000
extern PLUGIN_INFO g_layerRadioLongSendCfg;		// 电台长发
...
#endif
extern PLUGIN_INFO g_layer_cur_EleQ;//当日当月电量
...
extern PLUGIN_INFO g_wirelessComm_set; // 参数设置
extern PLUGIN_INFO g_changePwd;
