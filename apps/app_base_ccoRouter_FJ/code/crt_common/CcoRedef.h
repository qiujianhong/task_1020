...
#define MAX_NORMAL_AMR_INFO_CNT     5            //并行最大抄表个数
...
/*******************************************************************************
* 每次读取 删除 添加 路由的数目 实际每次cco回复的数量大概在五六十个
*******************************************************************************/
...
#if STAT_FUN
    struct timeval  msgrecvtime;             //收到消息的时间
    struct timeval  downsendtime;            //下行发送的时间
    struct timeval  downrecvtime;            //下行收到的时间
#endif
